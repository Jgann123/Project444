...
function Founders() {
    ...
    <div className="images_div">
        <div className="image_div3">
         ...
         <em>"Dont Spend your life on building something for yourself. Instead... spend it giving your life away for something greater."</em>
         <p id="p-tag"><br></br>
            Jeremy is a husband and father who is East TN native. As a Software Engineer and business owner he cares deeply about others and serving his community. He is a problem solver who is dedicated to making the
        ...
        <div className="image_div3">
         ...
         <p id="p-tag"><br></br>Tim Bishop is a passionate father and husband who has a knack for innovation. With years of experience in business
